...
part of RestaurantHomePage_Event;
...
class _$GetShortVidoes extends GetShortVidoes {
  factory _$GetShortVidoes([void Function(GetShortVidoesBuilder)? updates]) =>
      (new GetShortVidoesBuilder()..update(updates))._build();

  _$GetShortVidoes._() : super._();

  @override
  GetShortVidoes rebuild(void Function(GetShortVidoesBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetShortVidoesBuilder toBuilder() =>
      new GetShortVidoesBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetShortVidoes;
  }
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper(r'GetShortVidoes').toString();
  }
}

class GetShortVidoesBuilder
    implements Builder<GetShortVidoes, GetShortVidoesBuilder> {
  _$GetShortVidoes? _$v;

  GetShortVidoesBuilder();

  @override
  void replace(GetShortVidoes other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GetShortVidoes;
  }

  @override
  void update(void Function(GetShortVidoesBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GetShortVidoes build() => _build();

  _$GetShortVidoes _build() {
    final _$result = _$v ?? new _$GetShortVidoes._();
    replace(_$result);
    return _$result;
  }
}
