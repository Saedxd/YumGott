...
class RestaurantHomePageBloc extends Bloc<RestaurantHomePageEvent, RestaurantHomePageState> {
  IRepository _repository;

  RestaurantHomePageBloc(this._repository) : super(RestaurantHomePageState.initail());

  @override
  RestaurantHomePageState get initialState => RestaurantHomePageState.initail();

  @override
  Stream<RestaurantHomePageState> mapEventToState(
      RestaurantHomePageEvent event,
  ) async* {
    ...
    //     state.Filtered_Products!.clear();
    //     final date = await _repository.GetAllProducts(-1,10);
    //
    //     print('get Success data $date');
    //     yield state.rebuild((b) => b
    ...
    //       Product pro = Product();
    //       pro.Image = state.GetAllProducts!.data![i].image_path.toString();
    //       pro.Description = state.GetAllProducts!.data![i].bio.toString();
    //       pro.Name = state.GetAllProducts!.data![i].name.toString();
    //       pro.price = state.GetAllProducts!.data![i].price.toString();
    //       pro.ID = state.GetAllProducts!.data![i].id.toString();
    //       pro.Ratting =  state.GetAllProducts!.data![i].ratingsAverage!;
    //
    //
