...
class ProductListTile extends StatefulWidget {
  ProductListTile({Key? key,required this.Tile,required this.index}) : super(key: key);
    ...
    return Container(
      ...
      child: Row(
        ...
        children:[
                 ...
                 child:
                     CircleAvatar(
                       ...
                       child:     ClipOval(
                           child:
                           Image.asset(
                             widget.Tile.Products![widget.index].Image.toString(),fit: BoxFit.fill,
                           )),
                     )
               ...
               child: Column(
                 children: [
                   Container(
                     width: 137.w,
                     child: Text(
                     widget.Tile.Products![widget.index].Name.toString(),
                   ...
                   Container(
                     ...
                     child: Text(
                         widget.Tile.Products![widget.index].Description.toString(),
                         textAlign: TextAlign.left,
                         style: Montserrat.copyWith(
                             fontSize: 10.sp,
         ...
         Container(
           child:  Text(
             '\$ ${widget.Tile.Products![widget.index].price.toString()}',
