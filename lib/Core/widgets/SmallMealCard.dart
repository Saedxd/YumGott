...
//
// class SmallMealCard extends StatefulWidget {
//   SmallMealCard({Key? key,required this.index}) : super(key: key);
// //  BuiltList<ProductModel>? Product;
//   int? index=0;
//   @override
//   State<SmallMealCard> createState() => _SmallMealCardState();
// }
//
// class _SmallMealCardState extends State<SmallMealCard> {
//   @override
...
//
//               Container(
//                 margin: EdgeInsets.only(left: 10.w,top: 9.h),
//                 width: 145.w,
//                 child: Text(
...
//               ),
//               Container(
//                 margin: EdgeInsets.only(left: 10.w,top: 2.h,right: 19.w),
//                 width: 145.w,
//                 child: Text(
...
//                       children: [
//                         Container(
//                           margin: EdgeInsets.only(left: 9.w,top: 6.h),
//                           child: Text(
