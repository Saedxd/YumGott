...
class MyNotification {
   Future<void> initialize(FlutterLocalNotificationsPlugin fltNotification) async {
    ...
    fltNotification.initialize(initSetting,onSelectNotification: (String? payload) {
      try {
    ...
    var generalNotificationDetails = NotificationDetails(android: androidNotificationsDetails, iOS: iosDetails);
